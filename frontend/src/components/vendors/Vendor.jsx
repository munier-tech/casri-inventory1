...
const CreatePurchaseModal = ({ isOpen, onClose, vendors, onCreate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // REMOVED THE MANUAL VENDOR VALIDATION THAT WAS CAUSING THE ALERT
    ...
    try {
      ...
      const purchaseData = {
        ...
        vendorPhone: selectedVendor?.phoneNumber || '',
        amountDue: parseFloat(formData.amountDue),
        amountPaid: 0,
        paymentMethod: formData.paymentMethod,
        notes: formData.notes,
        purchaseDate: new Date().toISOString(),
        products: [] // Add empty products array for now
      };
...
const Vendor = () => {
  ...
  const handleCreatePurchase = async (purchaseData) => {
    ...
    try {
      ...
      console.error('Error in handleCreatePurchase:', error);
